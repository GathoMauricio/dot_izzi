...
while($fila=mysqli_fetch_array($datos)){
	...
	echo ' 
		...
		'.$botonPago.'
		<button class="btn btn-danger" id="'.$fila['id_expediente'].'" onclick="eliminarExpediente(this.id);" title="Eliminar este servicio"><span class="glyphicon glyphicon-trash"></span></button>
		</td>
		</tr>
		';
