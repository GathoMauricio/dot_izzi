...
<!--Barra de Navegacion-->
    ...
    <img src="../img/logo.png" id="logo_dot">
     ...
     <br><br>
     <!--RESERVADO PARA NOTIFICACIONES-->
     <div id="div_notificacion"></div>
     <br>
     <div class="publicacion">
     <table class="table"> 
        <tr>
        <td><label for="expediente">Fecha</label> </td><td><input type="date" class="form-control" id="fecha_gerente"></td><td><button class="btn btn-default" id="btn_buscar" onclick="buscarFecha('gerente');"><span class="glyphicon glyphicon-search"></span> Buscar </button></td>
        </tr>
        <tr>
        <td><label for="expediente">N° Expediente</label></td><td><input type="text" class="form-control" id="expediente_gerente" onkeypress="soloNumeros();" maxlength="10" placeholder="N° de Expediente"></td><td><button class="btn btn-default" id="btn_buscar" onclick="buscarExpediente('gerente');"><span class="glyphicon glyphicon-search"></span> Buscar </button></td>
        </tr>
        <tr>
            <center>
            <?php
    ...
    <br>
     ...
     <div id="contenedor_servicios_gerente"></div>
...
<?php include "modal_geolocalizacion.php" ?>   
