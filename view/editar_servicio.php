...
<!--Barra de Navegacion-->
    ...
    while($fila=mysqli_fetch_array($datos)){
     ...
     <form class="form-horizontal" method="POST" action="../control/actualizar_servicio.php">
        ...
        <div class="form-group">
             ...
             <div class="col-sm-4">
                 <select id="tipo" name="tipo" class="form-control" onchange="cargarTecnicosEdit();">
                    <?php 
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4" id="select_tecnico">
                ...
                while($fila=mysqli_fetch_array($datos))
                {
                    ...
                    if($fila['id_empleado']==$tecnico)
                    {
                      echo "<option  value='".$fila['id_empleado']."' selected>".$fila['nombre']." ".$fila['apaterno']." ".$fila['amaterno']."</option>";  
                    }else
                    {
